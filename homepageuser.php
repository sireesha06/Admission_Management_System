...
$sta1 = mysqli_query($con,"select * from t_user_data where s_id='".$_SESSION['user']."'");
$stat1 =  mysqli_fetch_assoc($sta1);
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 ...
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    Online Application System For Admission Management System</font></center>
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      ...
                      $resdata = mysqli_query($con,"SELECT * FROM t_user_data WHERE s_id='".$_SESSION['user']."' LIMIT 1");
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo 'Address :'. $row[15] ?><br>
                          <?php echo 'State :'. $row[16] ?><br>
                          <?php echo 'Pin :'. $row[17] ?><br>
                          <?php echo 'Mobile :'. $row[18] ?><br>
                </td>
                </tr>   
               
                <tr>
                    <td> <font style="font-family: Verdana;">Area</font>
               ...
               <tr>
                    ...
                    <td colspan="3"><?php echo $row[26] ?>
                     </td>
               </tr>
               <tr>
                     <td><font style="font-family: Verdana;">College Name</font></td>
                     <td colspan="3"><?php echo $row[27] ?>
                     </td>
                       ...
                       <table class="table table-hover">
                           ...
                           <tr>
                               <td><font style="font-family: Verdana;">Medium of Instruction till class 10th</font></td>
                                    ...
                                    <td colspan="3"><?php echo $row[41] ?></td>
                            ...
                            <div class="col-sm-12">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <p align="right"> <?php if($stat1['status'] == '1') {
                                          echo "Admission Confirmed"; }else if($stat1['status'] == '2'){
                                            echo "Rejected";
                                          }else{
                                            echo "Applied";
                                          } ?></p></font>
                                    ...
                                    <!-- <li class="list-group-item">
                                        ...
                                        <p align="right" style="font-family: Verdana; font-size:15px;">
                                            <a href="admit2.php">Click Here</a>
                                         </p>
					                          </li> -->
                                   <!--  <li class="list-group-item">
                                        <font style="font-family: Verdana; font-size:15px;"> 4) Payment Status(It takes 48 hours to reflect your status success)</font>
                                        <p align="right" style="font-family: Verdana; font-size:15px;">
                                            <a href="payment.php">Click Here</a>
                                         </p>
                                    </li>  --> 
