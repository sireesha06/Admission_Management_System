...
if(isset($_REQUEST["in_sub"]))
{
    ...
    $sql .= ""sysdate()",";
    $sql .= '0');*/
    $sql  = "INSERT INTO t_user_data (s_id, s_pwd, s_dob, s_name, s_email, s_mob, s_signupdate) VALUES ('" . $stid . "','" . $stpw . "','" . $dob . "','" . $name . "','" . $eml . "','" . $mob . "','".$date."')";
            ...
            <img src="images/signup1.jpg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;" ></img>
             ...
             <div id="drig">
                 ...
                 <center><font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:20px;">
                    ...
                    You are successfully registered. Please note your username and password. </font></center>
                 <br><br>
