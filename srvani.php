 ...
 $moi  = $_REQUEST["moi"];
    ...
    if(isset($_REQUEST["frmnext"]))
    {
      ...
      //  $sql .= "'" . $pcm . "',";
       ...
       echo  $sql1  = "insert into t_status values(";
        $sql1 .= "'" . $_SESSION['user'] ."',";
        $sql1 .= "'Applied')";die;
     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            ...
            <table class="frmtbl">
                ...
                <tr>
                    <td><font style="font-family: Verdana;"> Parent's Income </font>
                     <td  colspan="3"><input type="text" id="inc" name="inc" required="true" ></td>
                </tr>
                
                <tr>
                    <td> <font style="font-family: Verdana;">Genger </font>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="cadr" name="cadr" placeholder="D.no...exc" class="ad" required="true"><br>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" id="padr" name="padr" placeholder="D.no...exc" class="ad" required="true"><br>
                ...
                <tr>
                    <td><font style="font-family: Verdana;">Select Area Type</font>
                ...
                <tr><td><font style="font-family: Verdana;">Select Your Caste</font>
                    <td colspan="4"><input type="radio" id="cat" name="cat" value="SC"><font style="font-family: Verdana;">
                        ...
                        <input type="radio" id="cat" name="cat" value="BC"><font style="font-family: Verdana;">BC</font>
                        <input type="radio" id="cat" name="cat" value="OC"><font style="font-family: Verdana;">OC</font></td>
                 </tr>
